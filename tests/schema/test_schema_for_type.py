...
@pytest.mark.parametrize(
    ...
    [
        ({"simple": 1}, {"simple": 1}),
        (
            {"group": {"live": ["sensor.a"], "forecast": ["sensor.b"]}},
            {"group:live": ["sensor.a"], "group:forecast": ["sensor.b"]},
        ),
    ],
)
def test_flatten_and_unflatten_helpers(structured: dict[str, Any], flat: dict[str, Any]) -> None:
    """Structured configuration data round-trips through flatten helpers."""
